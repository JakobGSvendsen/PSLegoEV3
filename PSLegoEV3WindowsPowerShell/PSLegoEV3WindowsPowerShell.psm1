...
Function Invoke-EV3Forward {
    param(
     ...
     $script:brick.BatchCommand.StepMotorAtPower($OutputPortLeft,100,$Steps,$false)
        $script:brick.BatchCommand.StepMotorAtPower($OutputPortRight,100,$Steps,$false)
    $script:brick.BatchCommand.SendCommandAsync()
}
